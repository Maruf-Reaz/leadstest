...
namespace EntityFramworkFirstApp.Controllers
{
    public class SemestersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SemesterName")] Semester semester)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SemesterName")] Semester semester)
        {
            if (id != semester.Id)
            {
                return NotFound();
